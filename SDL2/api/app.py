...
from resources.user import create_user, get_otp, get_users, create_projecten, show_all_project
...
app.add_url_rule('/projecten', None, show_all_project, methods=['GET'])
